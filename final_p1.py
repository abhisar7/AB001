...
Original file is located at
    https://colab.research.google.com/drive/1jfxJ35wWmm0iNJP8Nek7kTr9kR7vnMPS
...
total_data = pd.read_csv("C:/Users/abhis/ml_pro/content/dataset.csv", encoding="ISO-8859-1")
with open('C:/Users/abhis/ml_pro/content/contractions.json', 'r') as f:
...
# total_data['SentimentText']

# total_data['processed_tweet']
...
tokenized_tweet = total_data['processed_tweet'].apply(word_tokenize)
# total_data['processed_tweet'] = total_data['processed_tweet'].apply(word_tokenize)
...
final_vectorized_data = count_vectorizer.fit_transform(total_data['processed_tweet'])  #bag of words
